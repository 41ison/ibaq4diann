...
| `plot_ibaq_pca()`           | Principal component analysis using KNN for clustering      |
| `plot_ibaq_pie()`           | Pie chart for proportion of abundance from each protein    |

> I can hear your thoughts! pie chart is a bad plot.
...
# Principal component analysis (KNN clustering)
plot_ibaq_pca(ibaq)

# Pie chart of protein abundance proportions
plot_ibaq_pie(ibaq, top_n = 10)
```
