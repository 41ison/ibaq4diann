...
# ibaq4diann <img src="man/figures/logo.png" align="right" height="139" alt="" />

<!-- badges: start -->
[![R-CMD-check](https://github.com/AlisonChaves/ibaq4diann/actions/workflows/R-CMD-check.yaml/badge.svg)](https://github.com/AlisonChaves/ibaq4diann/actions/workflows/R-CMD-check.yaml)
...
# Compute iBAQ values (wide format, log2-transformed)
ibaq <- compute_ibaq(
